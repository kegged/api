...
UserController.userEagerGraph = [{ model: _models2.default.Post, as: 'posts', include: [{ model: _models2.default.Brewery, as: 'brewery', include: [{ model: _models2.default.City, as: 'city' }] }, { model: _models2.default.PostTag, as: 'tags', include: [{ model: _models2.default.Tag, as: 'tag' }] }] }, { model: _models2.default.Comment, as: 'comments', include: [{ model: _models2.default.Post, as: 'post', include: [{ model: _models2.default.Brewery, as: 'brewery', include: [{ model: _models2.default.City, as: 'city' }] }, { model: _models2.default.PostTag, as: 'tags', include: [{ model: _models2.default.Tag, as: 'tag' }] }] }] }];